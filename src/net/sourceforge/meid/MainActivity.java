...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PreferenceManager.setDefaultValues(this, R.layout.histogram, false);
        ...
        if( !has_done_first_time && !is_test ) {
            ...
            alertDialog.setMessage("Touch to focus, and press the camera button to take photos. MEID is completely free.");
    ...
    public void layoutUI() {
		...
		if( ( relative_orientation == 0 && ui_placement_right ) || ( relative_orientation == 180 && ui_placement_right ) || relative_orientation == 90 || relative_orientation == 270) {
			...
			view = findViewById(R.id.histogram);
			layoutParams = (RelativeLayout.LayoutParams)view.getLayoutParams();
			layoutParams.addRule(align_parent_top, RelativeLayout.TRUE);
			layoutParams.addRule(align_parent_bottom, 0);
			...
			view = findViewById(R.id.insert);
			layoutParams = (RelativeLayout.LayoutParams)view.getLayoutParams();
			layoutParams.addRule(align_parent_top, RelativeLayout.TRUE);
			layoutParams.addRule(align_parent_bottom, 0);
			layoutParams.addRule(left_of, R.id.histogram);
			layoutParams.addRule(right_of, 0);
			view.setLayoutParams(layoutParams);
			view.setRotation(ui_rotation);
			...
			layoutParams.addRule(align_parent_bottom, 0);
			layoutParams.addRule(left_of, 0);
			layoutParams.addRule(right_of, R.id.trash);
			view.setLayoutParams(layoutParams);
			view.setRotation(ui_rotation);
			...
			layoutParams.addRule(align_parent_bottom, 0);
			layoutParams.addRule(left_of, 0);
			layoutParams.addRule(right_of, R.id.histogram);
			view.setLayoutParams(layoutParams);
			view.setRotation(ui_rotation);
    ...
    public void clickedHistogram(View view) {
		if( MyDebug.LOG )
			Log.d(TAG, "clickedHistogram");
		String preview_image_name= this.preview.clickedHistogram();
		Intent intent = new Intent(this,histogram.class);		
		intent.putExtra("names", preview_image_name);
		this.startActivity(intent);

    }
    
    public void clickedInsert(View view) {
		if( MyDebug.LOG )
			Log.d(TAG, "clickedInsert");
		//String preview_image_name= this.preview.clickedHistogram();
    ...
    public File getImageFolder() {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
		String folder_name = sharedPreferences.getString("preference_save_location", "MEID");
		File file = null;
